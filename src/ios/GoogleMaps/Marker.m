...
-(void)setPopoutAnimation_:(GMSMarker *)marker pluginResult:(CDVPluginResult *)pluginResult callbackId:(NSString*)callbackId {
    ...
    CATransform3D overshootScale = CATransform3DScale (marker.layer.transform, 1.2, 1.2, 0);
    CATransform3D endingScale = CATransform3DScale (marker.layer.transform, 1.0, 1.0, 1.0);
    ...
    delegate.imageView = [[UIImageView alloc] initWithFrame:CGRectMake(
                                                                       ...
                                                                       point.y - marker.icon.size.height/2,
